...
const { Account, Task, CommonFolder, Subscription, SubscriptionResource, StrmConfig, TaskProcessedFile, WorkflowRun, SystemLog } = require('../entities');
...
const AppDataSource = new DataSource({
    ...
    entities: [Account, Task, CommonFolder, Subscription, SubscriptionResource, StrmConfig, TaskProcessedFile, WorkflowRun, SystemLog],
    subscribers: [],
    migrations: [],
