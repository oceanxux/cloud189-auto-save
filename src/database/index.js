...
const { Account, Task, CommonFolder, Subscription, SubscriptionResource, StrmConfig, TaskProcessedFile, WorkflowRun, SystemLog, TmdbCache } = require('../entities');
...
const AppDataSource = new DataSource({
    ...
    entities: [Account, Task, CommonFolder, Subscription, SubscriptionResource, StrmConfig, TaskProcessedFile, WorkflowRun, SystemLog, TmdbCache],
    subscribers: [],
    migrations: [],
